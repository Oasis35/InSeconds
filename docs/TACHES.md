...
- [ ] **Limiter 80/443 aux plages Cloudflare** (UFW, sur le VPS) — l'IP du VPS a été publiée dans `CLAUDE.md` jusqu'au 2026-09-25 (encore visible dans l'historique git) : tant que 80/443 sont ouverts à tous, on peut attaquer Caddy directement, sans le WAF ni l'anti-DDoS de Cloudflare. Autoriser 80/443 uniquement depuis https://www.cloudflare.com/ips-v4 et ips-v6 (SSH inchangé), ou activer Authenticated Origin Pulls. Pour que l'IP connue ne serve plus du tout, changer d'IP (OVH : IP additionnelle ou nouveau VPS)
